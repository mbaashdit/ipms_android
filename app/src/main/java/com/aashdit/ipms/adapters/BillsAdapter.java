...
import com.aashdit.ipms.ui.activities.GenerateBillActivity;
 ...
 */
public class BillsAdapter extends RecyclerView.Adapter<BillsAdapter.TempBillViewHolder> {

    private static final String TAG = BillsAdapter.class.getSimpleName();

    private Context mContext;
    private List<TempBill> bills;


    public BillsAdapter(Context context, List<TempBill> data) {
    ...
    public TempBillViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.cell_view_bills, viewGroup, false);
