 ...
 */
public class WorkComponentsAdapter extends RecyclerView.Adapter<WorkComponentsAdapter.WorkComponentsViewHolder> {

    private static final String TAG = WorkComponentsAdapter.class.getSimpleName();
    ...
    public WorkComponentsAdapter(Context context, List<PlanableWorks> data, String type) {
    ...
    public void onBindViewHolder(@NonNull WorkComponentsViewHolder holder, int position) {
        ...
        holder.mTvEstEndDate.setText("Est.End Date : " + pw.estimatedEndDate);
            if (pw.duration.equals("")){
                holder.mTvTotalDuration.setText("0");
            }else {
                holder.mTvTotalDuration.setText("" + pw.duration);
            }
...
//                        isLongPressed = true;
//                        isSelected = true;
//                        workComponentListener.workComponentClick(type, position, pw.workComponentName, true);
...
//        }
    ...
    public interface OnWorkComponentListener {
        void workComponentClick(String type, int position, String compName);
...
//        void enableMultiSelect(int position, PlanableWorks work, boolean isSelected);
    ...
    public static class WorkComponentsViewHolder extends RecyclerView.ViewHolder {
        ...
        public WorkComponentsViewHolder(View itemView) {
            ...
            mTvTotalDuration = itemView.findViewById(R.id.tv_wc_total_duration_count);
